...
bot.onText(/\/start/, (msg) => {
  ...
  bot.sendMessage(chatId, `👋 Hi there, welcome to my Web Dev Portfolio Assistant! 
...
bot.onText(/\/projects/, (msg) => {
  bot.sendMessage(msg.chat.id, `🚀 Here are some of my projects:
...
bot.onText(/\/skills/, (msg) => {
  bot.sendMessage(msg.chat.id, `💻 Here are the skills I specialize in:
  - 🌟 HTML, CSS, JavaScript
...
bot.onText(/\/contact/, (msg) => {
  bot.sendMessage(msg.chat.id, `📞 You can contact me via:
...
bot.onText(/\/hireme/, (msg) => {
  ...
  // Sending the CV link
  bot.sendMessage(chatId, `📄 Here's a link to my CV: [Download CV](https://debayanmukherjee.vercel.app/files/2024%20Cv.pdf)`);

  // Prompting the user to schedule a meeting
  bot.sendMessage(chatId, `📅 If you're interested in scheduling a meeting, feel free to reach out to me via email `);
});
